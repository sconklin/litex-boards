...
def main():
    ...
    parser.add_target_argument("--remote-ip", default="172.31.0.230",  help="Remote IP address of TFTP server.")
    parser.add_target_argument("--local-ip",  default="172.31.0.231",   help="Local IP address.")
